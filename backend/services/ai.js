            ...
            messages: [
                {
                    ...
                    content: [
                        {
                            type: "text",
                            text: "Проанализируй это блюдо и определи КБЖУ на порцию. Ответь в JSON формате: {\"name\": \"название блюда\", \"portion\": \"примерный вес\", \"calories\": число, \"protein\": число, \"fats\": число, \"carbs\": число, \"advice\": \"совет по питанию\"}. Пожалуйста, строго соблюдай имена полей на английском."
                        },
                        {
                            type: "image_url",
                            image_url: {
